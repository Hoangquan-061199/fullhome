$(function () {
  ...
  $('.lst-part').owlCarousel({
    ...
    autoplay: !0,
    navText: [
      '<img src="/html/style/image/ic-arrow-left.png" alt="">',
      '<img src="/html/style/image/ic-arrow-right.png" alt="">',
    ],
    responsive: {
      0: { items: 2 },
      600: { items: 4 },
  ...
  $('.slide-project ._proj-dt').owlCarousel({
    loop: !1,
    margin: 25,
    items: 3,
    dots: !1,
  ...
  $('.lst_other_post').owlCarousel({
    ...
    nav: !0,
    navText: [
      '<img src="/html/style/image/ic-arrow-left-news.png" alt="">',
      '<img src="/html/style/image/ic-arrow-right-news.png" alt="">',
    ],
    responsive: {
      0: { items: 1 },
      600: { items: 2 },
  ...
  $('.project-completed .right').owlCarousel({
    loop: 1,
    margin: 25,
    items: 3,
    nav: true,
    navText: [
      '<img src="/image/ic-arrow-left-news.png" alt="">',
      '<img src="/image/ic-arrow-right-news.png" alt="">',
    ],
    responsive: {
      0: { items: 1 },
      600: { items: 2 },
  ...
  if ($(window).width() < 992) {
    ...
    $('.lst_fiel .slide_fiel').owlCarousel({
      loop: !1,
      dots: !1,
      margin: 15,
      items: 2,
  ...
  if ($(window).width() >= 768) {
    ...
    resizeImage(
      '.pro-dt ._pro-dt .left .lSSlideOuter .lSPager.lSGallery li',
      120 / 180
    );
  ...
  if ($(window).width() < 768) {
    ...
    resizeImage(
      '.project .project-cnt .pic,.project .project-cnt .img , .fiel-active .fiel-cnt .it .img',
      9 / 16
    );
  ...
  fixintro = function () {
    ...
    1025 < $(window).width() &&
      (50 < d && $('header').addClass('fixed'),
      d < 50 && $('header').removeClass('fixed')),
      $(window).width() < 1025 &&
        ($('header').addClass('fixed'),
        $('._banner').css({ 'margin-top': $('header').height() }));
  };
  fixintro();
